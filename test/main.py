...
if __name__ == '__main__':
    ...
    model_path = bytes("/home/jiaopan/projects/c++/detector-onnx-linux/model/yolov5s-320.onnx", "utf-8")
    ...
    cap = cv2.VideoCapture("http://112.50.243.8/PLTV/88888888/224/3221225900/1.m3u8")
    index = 0;
    ...
    if cap.isOpened():
        while True:
            ...
            if index % 5 == 0:
                ...
                result = detect(image, ctypes.c_float(0.6))
                result = ctypes.string_at(result, -1).decode("utf-8")
