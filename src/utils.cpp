...
void utils::createInputImage(std::vector<float> &input, cv::Mat image,bool normalization, const int width, int height, int channels) {
...
void utils::createInputImage(std::vector<float> &input, cv::Mat image, const int width, int height, int channels) {
