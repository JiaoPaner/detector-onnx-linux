...
class utils {
    public:
        static void createInputImage(std::vector<float> &input,cv::Mat image,bool normalization,const int width=640,int height=640, int channels=3);
        static void createInputImage(std::vector<float> &input,cv::Mat image,const int width=640,int height=640, int channels=3);
